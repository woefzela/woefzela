...
public class SaveRespondentProfile {
	
	//fix lowercase later
	private static final String TAG = "SaveRespondentProfile";
	...
	private static final String profileFolderSubdir = "/Respondents"; //get later from resource
	...
	public SaveRespondentProfile(Context context, String sFWName, String sFWSurname, String sAge, String sFWMobile, String sFWEmail, String sLanguage, String sGender, String sTerms, String profileKey, String appVersion) {
    	...
    	filename = constructFilename(sFWName, sFWSurname, sAge);
		...
		if (mExternalStorageWriteable != false) {
			...
			try {
			    ...
			    if (root.canWrite()){
			        ...
			        p = fid.getAbsolutePath();
			        
			        Log.d(TAG,"fid.getAbsolutePath() = " + p);
	        		...
	        		out.write(sAge); out.write(NEWLINE);
	        		out.write(sFWMobile); out.write(NEWLINE);
	        		out.write(sFWEmail); out.write(NEWLINE);
	        		out.write(sLanguage); out.write(NEWLINE);
	        		out.write(sGender); out.write(NEWLINE);
	        		out.write(sTerms); out.write(NEWLINE);
	        		out.write(profileKey); out.write(NEWLINE);
	        		out.write(appVersion); out.write(NEWLINE);
			        			        
			        out.close();
			        
			        Log.i(TAG,"Committing appVersion to Respondent profile = " + appVersion);
			    }
			    else {
	...
	public String getFullFilenameWithPath() {
		Log.d(TAG,"getFullFilenameWithPath = " + p);
		return p;
	}
	
	public String constructFilename(String sFWName, String sFWSurname, String sAge) {
		String name = removeSpaces(sFWName);
		String surname = removeSpaces(sFWSurname);
		String age = removeSpaces(sAge);
		Log.i(TAG,"constructFilename = " + name + surname + age);
